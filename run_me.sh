...
echo "📋 Next Steps:"
echo ""
echo "1. Configure Cursor (see README.md Step 3):"
echo "   - Open Cursor Settings (Cmd/Ctrl + ,)"
echo "   - Search for 'MCP'"
echo "   - Add server: http://localhost:8050/sse"
echo "   - Restart Cursor"
echo ""
echo "2. Test in Cursor:"
echo "   'Analyze the repository jolly-commerce/jolly-sections'"
echo ""
